 ...
 */
package fr.unice.polytech.robotproject.validation;
...
public class RobotdslValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(RobotdslConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("Robotdsl");
		if (section == null) {
			return dialogSettings.addNewSection("Robotdsl");
		}
		return section;
	}
}
