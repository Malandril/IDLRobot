...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.robotproject.model.RobotProjectModel.Print} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrintItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Print_string_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Print_string_feature", "_UI_Print_type"),
				 RobotProjectModelPackage.Literals.PRINT__STRING,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Print)object).getString();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Print.class)) {
			case RobotProjectModelPackage.PRINT__STRING:
