...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.robotproject.model.RobotProjectModel.GoTo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GoToItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GoTo_destination_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GoTo_destination_feature", "_UI_GoTo_type"),
				 RobotProjectModelPackage.Literals.GO_TO__DESTINATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RobotProjectModelPackage.Literals.GO_TO__CONDITION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GoTo.class)) {
			case RobotProjectModelPackage.GO_TO__CONDITION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RobotProjectModelPackage.Literals.GO_TO__CONDITION,
