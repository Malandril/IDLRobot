...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.robotproject.model.RobotProjectModel.Duration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DurationItemProvider extends AmountItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Duration_timeUnit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Duration_timeUnit_feature", "_UI_Duration_type"),
				 RobotProjectModelPackage.Literals.DURATION__TIME_UNIT,
				 true,
				 false,
				 false,
