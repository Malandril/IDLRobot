...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.robotproject.model.RobotProjectModel.Function} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RobotProjectModelPackage.Literals.FUNCTION__NAME,
				 true,
				 false,
				 false,
	...
	protected void addInstructionBlockPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Function_instructionBlock_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Function_instructionBlock_feature", "_UI_Function_type"),
				 RobotProjectModelPackage.Literals.FUNCTION__INSTRUCTION_BLOCK,
				 true,
				 false,
				 true,
				 null,
