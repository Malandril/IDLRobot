 ...
 * </p>
 * <ul>
 *   <li>{@link fr.unice.polytech.robotproject.model.RobotProjectModel.impl.MoveImpl#getDistance <em>Distance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MoveImpl extends MinimalEObjectImpl.Container implements Move {
	...
	protected EClass eStaticClass() {
		return RobotProjectModelPackage.Literals.MOVE;
	}
	...
	public void setDistance(int newDistance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RobotProjectModelPackage.MOVE__DISTANCE, oldDistance, distance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RobotProjectModelPackage.MOVE__DISTANCE:
				return getDistance();
		}
