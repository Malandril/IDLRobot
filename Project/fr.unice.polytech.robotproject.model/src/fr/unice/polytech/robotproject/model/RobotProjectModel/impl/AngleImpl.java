 ...
 * </p>
 * <ul>
 *   <li>{@link fr.unice.polytech.robotproject.model.RobotProjectModel.impl.AngleImpl#getAngleUnit <em>Angle Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AngleImpl extends AmountImpl implements Angle {
	/**
	 ...
	 * @ordered
	 */
	protected static final AngleUnit ANGLE_UNIT_EDEFAULT = AngleUnit.DEGREES;
	...
	protected EClass eStaticClass() {
		return RobotProjectModelPackage.Literals.ANGLE;
	}
	...
	public void setAngleUnit(AngleUnit newAngleUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RobotProjectModelPackage.ANGLE__ANGLE_UNIT, oldAngleUnit, angleUnit));
	}
