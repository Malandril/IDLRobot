 ...
 *   <li>{@link fr.unice.polytech.robotproject.model.RobotProjectModel.impl.GoToImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GoToImpl extends MinimalEObjectImpl.Container implements GoTo {
	...
	public NotificationChain basicSetCondition(Condition newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RobotProjectModelPackage.GO_TO__CONDITION, oldCondition, newCondition);
	...
	public void setCondition(Condition newCondition) {
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject)condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RobotProjectModelPackage.GO_TO__CONDITION, null, msgs);
			if (newCondition != null)
				msgs = ((InternalEObject)newCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RobotProjectModelPackage.GO_TO__CONDITION, null, msgs);
			msgs = basicSetCondition(newCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RobotProjectModelPackage.GO_TO__CONDITION, newCondition, newCondition));
	}
